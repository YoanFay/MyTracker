...
class Serie
{
    ...
    #[ORM\Column(length: 255, nullable: true)]
    private ?string $next_aired_type = null;
    ...
    {
        return $this->next_aired_type;
    }

    public function setNextAiredType(?string $next_aired_type): static
    {
        $this->next_aired_type = $next_aired_type;
